...
from data.styles import first_row_style, first_row_border_style
...
class Test_Main:
    ...
    def test_get_price(self,driver):
        ...
        first_row = next(first_row_style())
        ...
        xlxs_proccess.format_row(first_row, border_style)
